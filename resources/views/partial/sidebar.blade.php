<section id="sidebar">
    <a href="{{ route('admin.dashboard') }}" class="brand">
        <i class='bx bxs-store-alt'></i> <span class="text">
            <span class="octa">Rizhaqy </span><span class="prime">Laundry</span>
        </span>
    </a>
    <ul class="side-menu top">
        ...
        <li class="{{ Request::is('admin/transaksi*') ? 'active' : '' }} has-dropdown">
            <a href="#" class="dropdown-toggle"> <i class='bx bxs-credit-card'></i>
        ...
        <li class="{{ Request::is('admin/pegawai*') ? 'active' : '' }} has-dropdown">
            ...
            <ul class="submenu">
                <li class="{{ Request::is('admin/pegawai') && !Request::is('admin/pegawai/*') ? 'active' : '' }}">
        ...
        <li class="{{ Request::is('admin/pelanggan*') ? 'active' : '' }} has-dropdown">
            ...
            <ul class="submenu">
                <li class="{{ Request::is('admin/pelanggan') && !Request::is('admin/pelanggan/*') ? 'active' : '' }}">
        ...
        <li class="{{ Request::is('admin/layanan*') ? 'active' : '' }} has-dropdown">
            ...
            <ul class="submenu">
                <li class="{{ Request::is('admin/layanan') && !Request::is('admin/layanan/*') ? 'active' : '' }}">
                    <a href="{{ route('admin.layanan.index') }}">
                        <i class='bx bx-list-ul'></i>
                        <span class="text">Data Layanan</span>
                    </a>
                </li>
        ...
        <li class="{{ Request::is('admin/alat*') ? 'active' : '' }} has-dropdown">
            ...
            <ul class="submenu">
                <li class="{{ Request::is('admin/alat') && !Request::is('admin/alat/*') ? 'active' : '' }}">
        ...
        <li class="{{ Request::is('admin/laporan*') ? 'active' : '' }} has-dropdown">
            ...
            <ul class="submenu">
                <li class="{{ Request::is('admin/laporan/transaksi') ? 'active' : '' }}">
                    <a href="{{ route('admin.laporan.transaksi') }}">
                        <i class='bx bx-list-ul'></i>
                        <span class="text">Ringkasan Transaksi</span>
                    </a>
                </li>
                <li class="{{ Request::is('admin/laporan/pendapatan') ? 'active' : '' }}">
