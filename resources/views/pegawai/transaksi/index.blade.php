                        ...
                        <table style="width: 100%; border-collapse: collapse;">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="btn-action-group">
                                            <a href="{{ route('pegawai.transaksi.show', 2) }}" class="btn-detail show"><i class='bx bx-show'></i></a>
                                        </div>
                                    </td>
                                </tr>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="btn-action-group">
                                            <a href="{{ route('pegawai.transaksi.show', 3) }}" class="btn-detail show"><i class='bx bx-show'></i></a>
                                        </div>
                                    </td>
                                </tr>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="btn-action-group">
                                            <a href="{{ route('pegawai.transaksi.show', 6) }}" class="btn-detail show"><i class='bx bx-show'></i></a>
                                        </div>
                                    </td>
                                </tr>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="btn-action-group">
                                            <a href="{{ route('pegawai.transaksi.show', 4) }}" class="btn-detail show"><i class='bx bx-show'></i></a>
                                        </div>
                                    </td>
                                </tr>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="btn-action-group">
                                            <a href="{{ route('pegawai.transaksi.show', 5) }}" class="btn-detail show"><i class='bx bx-show'></i></a>
                                        </div>
                                    </td>
                                </tr>
